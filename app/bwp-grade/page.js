        ...
        <section className="project-details" style={{paddingBottom:'400px'}}>
            <div className="container">
                <div className="project-details__img">
                    ...
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
                                <p><span>Standard:</span>IS:10701</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><span>Water Resistance:</span>72-hour boiling water test</p>
                            </li>
                            <li>
                                <p><span>Thickness Available:</span>4mm – 25mm</p>
                            </li>
                            <li>
                                <p><span>Termite & Borer Treatment:</span>Advanced preservative treatment</p>
                            </li>
                            <li>
                ...
                <div className="project-details__content">
                    ...
                    <p className="project-details__text">IS-10701 BWP Grade Plywood is a high-performance, waterproof plywood manufactured as<br/>
                     per the Indian Standard IS:10701. Engineered for long-lasting durability, this plywood delivers <br/>
                     exceptional resistance to water, humidity, weather changes, termites, and daily wear, making <br/>
                     it ideal for interior and exterior applications.</p>
