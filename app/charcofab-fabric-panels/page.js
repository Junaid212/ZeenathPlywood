...
return (
    <>
    <Layout headerStyle={3} footerStyle={3} breadcrumbTitle="CharcoFab Fabric Panels">      
    
    {/*Project Details Start*/}
    <section className="project-details" style={{paddingBottom:'250px'}}>
        <div className="container">
            <div className="project-details__img">
                <img src="assets/images/project/project-details-img-1.jpg" alt="CharcoFab Fabric Panels"/>
