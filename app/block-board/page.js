...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={5} footerStyle={3} breadcrumbTitle="Block Board">      
        {/*Project Details Start*/}
        <section className="project-details" style={{paddingBottom:'440px'}}>
            <div className="container">
                <div className="project-details__img">
                    <img src="assets/images/blog/20.webp" alt=""/>
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
        <p><span >Standard:</span> IS:1659</p>
    </li>
    <li>
        <p><span >Core:</span> Solid wooden blocks</p>
    </li>
    <li>
        <p><span>Face Veneer:</span> Hardwood / Best-quality veneer</p>
    </li>
    <li>
        <p><span >Bonding:</span> MR (Moisture Resistant), BWP (Boiling Waterproof)</p>
    </li>
    <li>
        <p><span>Moisture Content:</span> 5–15%</p>
    </li>
    <li>
        <p><span>Thickness Available:</span> 19mm, 25mm, others on request</p>
    </li>
    <li>
        <p><span >Tests Include:</span> Bending strength, Screw-holding, Knife test, Water resistance (BWP)</p>
    </li>
                            <li>
                ...
                <div className="project-details__content">
                    <h3 className="project-details__title">IS 1659 – Block Board<br/> <small>(High-Quality Interior & Exterior Grade)</small></h3>
                    <p className="project-details__text">IS 1659 Block Board is a high-strength wood panel manufactured as per the Indian Standard<br/>
                     IS:1659, designed for superior stability, durability, and load-bearing performance. Built using <br/>
                     a solid wooden block core sandwiched between high-quality veneers, this board offers excellent<br/>
                      resistance against bending, warping, and everyday wear.</p>
