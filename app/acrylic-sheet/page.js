        ...
        <section className="project-details" style={{paddingBottom:'380px'}}>
            <div className="container">
                <div className="project-details__img">
                    <img src="assets/images/laminate/50.webp" alt=""/>
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
    <p><span>Material:</span> PMMA (Polymethyl Methacrylate)</p>
</li>
<li>
    <p><span>Thickness:</span> 1mm – 20mm (varies by type)</p>
</li>
<li>
    <p><span>Size:</span> 8×4 ft (standard), custom sizes available</p>
</li>
<li>
    <p><span>Light Transmission:</span> Up to 92%</p>
</li>
<li>
    <p><span>Density:</span> ~1.19 g/cm³</p>
</li>
<li>
    <p><span>Temperature Resistance:</span> 80–100°C</p>
</li>
<li>
    <p><span>Finish Options:</span> Glossy, matte, frosted, textured</p>
</li>
<li>
    <p><span>Fabrication:</span> Laser cut, CNC, drill, bend</p>
</li>
                ...
                <div className="project-details__content">
                    <h3 className="project-details__title">Acrylic Sheets<br/>Transparent, Lightweight &<br/> High-Performance Plastic Panels</h3>
                    <p className="project-details__text">Acrylic Sheets (also known as PMMA sheets / Plexiglass sheets) are strong, lightweight, and <br/>
                    crystal-clear plastic panels widely used as a modern substitute for glass. Known for their <br/>
                    clarity, strength, and UV resistance, acrylic sheets are ideal for signage, interiors, displays,<br/>
                     furniture, and architectural applications.</p>
