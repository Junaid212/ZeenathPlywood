...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={5} footerStyle={3} breadcrumbTitle="Shuttering Grade">      
        {/*Project Details Start*/}
        <section className="project-details">
            <div className="container">
                <div className="project-details__img">
                    <img src="assets/images/blog/21.webp" alt=""/>
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
    <p><span>Standard:</span> IS:4990</p>
</li>
<li>
...
<li>
    <p><span>Density:</span> 750+ kg/m³ (varies by manufacturer)</p>
</li>
<li>
    <p><span>Moisture Content:</span> 5–15%</p>
</li>
<li>
    <p><span>Reusability:</span> 20–30+ uses (with proper care)</p>
</li>
<li>
    <p><span>Face Options:</span> Film faced (brown/black film), Non-film conventional shuttering plywood</p>
</li>
<li>
                ...
                <div className="project-details__content">
                    ...
                    <p className="project-details__text">IS 4990 Shuttering Grade Plywood is a high-strength, high-density plywood specially designed<br/>
                     for concrete formwork applications. Manufactured as per the Indian Standard IS:4990, this<br/>
                      ...
                      finishing for multiple reuses.</p>
