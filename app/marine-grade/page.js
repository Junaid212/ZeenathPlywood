...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={5} footerStyle={3} breadcrumbTitle="Marine Grade">      
        {/*Project Details Start*/}
        <section className="project-details" style={{marginBottom:'50px'}}>
            <div className="container">
                <div className="project-details__img">
                    ...
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
                                <p><span>Standard:</span>IS:710</p>
                            </li>
                            <li>
                                <p><span>Bonding:</span>Phenol Formaldehyde (PF) Resin</p>
                            </li>
                            <li>
                                <p><span>Core & Veneer: </span>High-density hardwood</p>
                            </li>
                            <li>
                                <p><span>Moisture Content:</span>5%–15%</p>
                            </li>
                            <li>
                                <p><span>Bending Strength:</span>High MOR & MOE values</p>
                            </li>
                            <li>
                                <p><span>Water Resistance:</span>72 hours continuous boiling test</p>
                            </li>
                            <li>
                ...
                <div className="project-details__content">
                    <h3 className="project-details__title">IS-710 Marine Grade Plywood</h3>
                    <p className="project-details__text">IS-710 Marine Grade Plywood is a premium quality, fully waterproof plywood manufactured <br/>
                    as per the Indian Standard IS:710. Designed for maximum durability and strength, it is the <br/>top choice for applications exposed to moisture, water, humidity, and outdoor conditions.</p>
