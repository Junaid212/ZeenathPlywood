...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={5} footerStyle={3} breadcrumbTitle="Bamboo Sheets">      
        {/*Project Details Start*/}
        <section className="project-details" style={{paddingBottom:'280px'}}>
            <div className="container">
                <div className="project-details__img">
                    <img src="assets/images/blog/24.webp" alt=""/>
                    <div className="project-details__information">
                        ...
                        <ul className="project-details__information-list list-unstyled">
                            <li>
    <p><span>Material:</span> 100% natural bamboo strips</p>
</li>
<li>
    <p><span>Thickness:</span> 6mm, 12mm, 16mm, 18mm, 25mm</p>
</li>
<li>
    <p><span>Sizes:</span> Standard plywood sheet sizes (e.g., 8x4 ft)</p>
</li>
<li>
    <p><span>Density:</span> High density, stronger than many hardwoods</p>
</li>
<li>
    <p><span>Finish:</span> Pre-sanded smooth surface</p>
</li>
<li>
    <p><span>Adhesive:</span> E0/E1 grade eco-friendly resin (varies by manufacturer)</p>
</li>
                ...
                <div className="project-details__content">
                    <h3 className="project-details__title">Bamboo Sheets – Sustainable,<br/> Strong & Modern Eco-Friendly<br/> Panels</h3>
                    <p className="project-details__text">Bamboo Sheets (also known as Bamboo Ply, Bamboo Boards, or Bamboo Panels) are <br/>
                    high-performance, eco-friendly engineered panels made from natural bamboo strips. <br/>
                    These sheets are known for their exceptional strength, smooth finish, and modern <br/>
                    aesthetic—making them a popular choice for premium furniture, interiors, and architectural<br/> applications.</p>
